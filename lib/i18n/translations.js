...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      continueToRevolut: 'Continue to Revolut Pay',
      ...
      revolutTitle: 'Revolut Pay',
      revolutDescription: 'Pay instantly with your Revolut account or any card via Revolut Pay.',
      revolutInfo: {
        title: 'Revolut Pay',
        description: 'You will be redirected to complete your payment securely through Revolut Pay.',
      },
      sepaInfo: {
  ...
  de: {
    ...
    checkout: {
      ...
      continueToRevolut: 'Weiter zu Revolut Pay',
      ...
      revolutTitle: 'Revolut Pay',
      revolutDescription: 'Bezahlen Sie sofort mit Ihrem Revolut-Konto oder einer beliebigen Karte über Revolut Pay.',
      revolutInfo: {
        title: 'Revolut Pay',
        description: 'Sie werden weitergeleitet, um Ihre Zahlung sicher über Revolut Pay abzuschließen.',
      },
      sepaInfo: {
