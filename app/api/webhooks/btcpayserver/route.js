  ...
  switch (eventType) {
    case "InvoiceSettled":
      if (order.paymentStatus !== "paid") {
        ...
        await awardLoyaltyPoints(order._id).catch((e) => console.error("Loyalty points error:", e));
        await sendOrderConfirmationEmail(order).catch((e) => console.error("Order confirmation email error:", e));
