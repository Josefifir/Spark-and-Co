...
const UpdateSchema = z.object({
  ...
  specs: z.array(z.object({ label: z.string().max(80), value: z.string().max(200) })).optional(),
  personalisationEnabled: z.boolean().optional(),
  personalisationPrompt: z.string().max(200).nullable().optional(),
  personalisationMaxLength: z.number().int().min(1).max(200).optional(),
  shippingRestrictions: z.array(z.string().max(2)).optional(),
