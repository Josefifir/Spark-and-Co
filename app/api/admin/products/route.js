...
const ProductSchema = z.object({
  ...
  preorderNote: z.string().max(300).nullable().optional(),
  specs: z.array(z.object({ label: z.string().max(80), value: z.string().max(200) })).optional().default([]),
  personalisationEnabled: z.boolean().default(false),
  personalisationPrompt: z.string().max(200).nullable().optional(),
  personalisationMaxLength: z.number().int().min(1).max(200).default(20),
  shippingRestrictions: z.array(z.string().max(2)).optional().default([]),
